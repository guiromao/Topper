...
public final class UserConstants {
    ...
    public static final String FIELD_LAST_VOTE_DATE = "lastVoteDate";
    public static final String FIELD_ROLES = "roles";

    public static final String PROPERTY_ID = "emailId";
    ...
    public static final String PROPERTY_LAST_VOTE_DATE = FIELD_LAST_VOTE_DATE;
